    ...
    const ProductDiscountChecker = ({ productId }) => {
        ...
        useEffect(() => {
            const checkDiscount = async () => {
                const isDiscounted = await checkProductDiscount(productId);
        ...
        if (isDiscounted === null) {
            return <td className="px-4 py-2 border-b">Đang kiểm tra...</td>;
        }
